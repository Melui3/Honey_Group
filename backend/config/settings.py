...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "Honey Group <noreply@honeygroup.mg>")
CONTACT_EMAIL = os.environ.get("CONTACT_EMAIL", "honeygroup.mg17@gmail.com")