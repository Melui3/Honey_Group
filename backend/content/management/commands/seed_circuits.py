...
DATA = [
    {
        ...
        "cover": "/media/circuits/cover-circuit-sud.webp",
        "featured": True,
        "notes": "",
        "gallery": [
            "/media/circuits/circuit-sud-1.webp",
            "/media/circuits/circuit-sud-2.webp",
            "/media/circuits/circuit-sud-3.webp",
        ],
    },
    {
        "id": "l-ouest",
        ...
        "cover": "/media/circuits/cover-circuit-ouest.webp",
        "featured": True,
        "notes": "",
        "gallery": [
            "/media/circuits/circuit-ouest-1.webp",
            "/media/circuits/circuit-ouest-2.webp",
            "/media/circuits/circuit-ouest-3.webp",
        ],
    },
    {
        "id": "le-nord",
        ...
        "cover": "/media/circuits/cover-circuit-nord.webp",
        "featured": True,
        "notes": "Fiche Diego manquante — on affiche un aperçu destination uniquement.",
        "gallery": [
            "/media/circuits/circuit-nord-1.webp",
            "/media/circuits/circuit-nord-2.webp",
            "/media/circuits/circuit-nord-3.webp",
        ],
    },
    {
        "id": "l-est",
        ...
        "cover": "/media/circuits/cover-circuit-est.webp",
        "featured": True,
        "notes": "",
        "gallery": [
            "/media/circuits/circuit-est-1.webp",
            "/media/circuits/circuit-est-2.webp",
            "/media/circuits/circuit-est-3.webp",
        ],
    },
    {
        ...
        "cover": "/media/circuits/cover-circuit-majunga.webp",
        "featured": False,
        "notes": "À compléter avec la fiche PDF quand elle est prête.",
        "gallery": [
            "/media/circuits/circuit-majunga-1.webp",
            "/media/circuits/circuit-majunga-2.webp",
    ...
    },
    {
        ...
        "cover": "/media/circuits/cover-circuit-manambato.webp",
        "featured": False,
        "notes": "À compléter avec la fiche PDF quand elle est prête.",
        "gallery": [
            "/media/circuits/circuit-manambato-1.webp",
            "/media/circuits/circuit-manambato-2.webp",
            "/media/circuits/circuit-manambato-3.webp",
        ],
    },
    {
        "id": "sud-makay",
        ...
        "gallery": [
            "/media/circuits/circuit-makay-1.webp",
            "/media/circuits/circuit-makay-2.webp",
            "/media/circuits/circuit-makay-3.webp",
        ],
    },
]
